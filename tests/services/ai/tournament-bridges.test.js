...
const TOURNAMENTS = [
  { id: 25, name: '7차 CK', type: 'auction', status: 'preparing', teamCount: 2, heldAt: null, championTeamId: null },
  { id: 20, name: '6차 CK', type: 'normal', status: 'finished', teamCount: 8, heldAt: new Date('2026-05-01'), championTeamId: 100 },
];

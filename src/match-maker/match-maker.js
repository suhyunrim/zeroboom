...
const matchMake = (preOrganizationTeam1, preOrganizationTeam2, userPool, count) => {
	if(preOrganizationTeam1.length + preOrganizationTeam2.length + userPool.length != PICK_COUNT)
	{
	...
	if(preOrganizationTeam1.length < TEAM_SIZE)
	{
	...
	if(!isFirstPick && preOrganizationTeam2.length < TEAM_SIZE)
	{
